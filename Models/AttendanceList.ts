...
export const AttendanceEntryModel =  mongoose.model('AttendanceEntry', AttendanceEntrySchema)
export const AttendanceListModel =  mongoose.model('AttendanceList', AttendanceListSchema)
